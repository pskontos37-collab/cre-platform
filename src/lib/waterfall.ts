...
// ----------------------------------------------------------------------------
// computeWaterfall (above) distributes a single lump sequentially and treats
// hurdle_irr as descriptive. This section adds a TRUE IRR-hurdle solver: given
// each partner's dated cash-flow history plus a new distribution event, it finds
// the exact amount that carries the LP to each tier's hurdle IRR before the
// promote split steps up.
//
