...
$bldRe=[regex]'^\d{4}$'
# KM East (Midway #0532), July 2026. Targets read from the file's own Totals: row at r192
# (184357 sqft / 316779.48 monthly). NOTE the file reports "32 Units" while the parse finds
# 39 occupied rows -- the extra 7 are 0-sf pad/ground/outparcel leases the file does not
# count as units. Only the MONTHLY figure is enforced (line ~104), and it matches exactly.
$files=@(
